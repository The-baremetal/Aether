...
Then we can load it into stack, in the following code, we
    ...
    extract value from loaded array
    insert value into loaded array
...
// any code that you cant convert will be commented out.

// from Environment import Environment environment is in the same package as compiler so theres no need to import it.
