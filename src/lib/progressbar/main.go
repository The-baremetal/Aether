...
// PrintLine moves the progress bar down a line then puts the text on top overriding the progressbar on the previous line completely
func (pb *ProgressBar) PrintLine(text string) {
	pb.Clear()
	fmt.Println(text)
}
